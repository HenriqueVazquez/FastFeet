...
// adiciona os jobs
const jobs = [CancellationDeliveryMail, CreationDeliveryMail, CancellationProblemDeliveryMail ];
...
class Queue {
  ...
  //armaenando na fila o bee que é nossa instancia que conecta com o redi
